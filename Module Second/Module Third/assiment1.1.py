# Task 2: Using the Math Module for Calclution

# problem statement: Write a python program that:
# 1.Ask me user for a number as input.
# 2.Use the math module to calclute the:
      # squre root of number
      # natural logarithm (log base e) of the number
      # sine of the number (in radian)
# 3.Display the calclute the result:
# Expeted output:
# for example, if the user enters the 25 ,the output should be:
   # Enter a number: 25
   # Square root: 5.0
   # logarithm: 3.2188758
   # sine: -o.1323517
